...
&ensp;&ensp;&ensp;it is not recommended to use Chris recursively, but if necessary, remember that it would operate faster if you pass a compare method in the form metioned above to compare Chris to each other, luckily, it still has better performance than stl set even you don't do so  
