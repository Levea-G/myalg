...
Chris.h is a header for C users, featuring rb-tree structure whose key can be any datatype the user defines, it might require few rules to use, which will be revealed once it's finished (some day), now have _init_/insert/f_all/dfs for users
